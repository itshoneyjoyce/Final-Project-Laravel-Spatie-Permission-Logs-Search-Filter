...
<body>
    <div class="container col-sm-4 offset-sm-4">
        ...
        <div class="card shadow mb-5 rounded border border-dark mt-5">
            <div class="card-body" style="background-color: #f9fbfc;" id="card-bodyy">
                <h2 class='text-center mt-2 mb-4 ' style="color: #0a0a0a; font-size: 25px;">Register</h2>
                <form action="{{ '/register' }}" method="POST">
                    ...
                    <div class="d-flex mt-4">
                        ...
                        <div class="form-group text-center mt-4 mr-4">
                            <button class="btn btn-outline-dark" id="actionBtn" type="submit"><img src="https://cdn-icons-png.flaticon.com/512/3031/3031748.png" width="20" height="20" class="rounded"> Submit</button>
                        </div>
                    </div>
                    </form>
            </div>
