...
<body>
    <div class="container col-md-4 offset-md-4">
        ...
        <div class="card shadow mb-5 rounded border border-dark mt-5">
            <div class="card-body rounded" style="background-color: #f5fbfc;" id="card-bodyy">
                <h2 class="text-center mb-4" style="color:#0a0a0a; font-size: 25px;">Log In</h2>
                <form action="{{ '/' }}" method="POST">
                    ...
                    <div class="d-flex">
                        <div class="flex-grow-1">
                            <a href="{{ '/register' }}" class="text-primary">Sign up for an account?</a>
                        </div>
                        <div class="form-group text-center mt-4 mr-4">
                            <button class="btn btn-outline-dark" id="actionBtn" type="submit"><img src="https://cdn-icons-png.flaticon.com/512/3031/3031748.png" width="20" height="20" class="rounded"> Login</button>
                        </div>
                    </div>
                    </form>
            </div>
