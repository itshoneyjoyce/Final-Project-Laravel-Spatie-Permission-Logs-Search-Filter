<div class="div">
    ...
    <div class="container ">
        <div class="profile">
            <h1 class="text-left" style="font-weight: 800; color:rgb(14, 105, 117); font-size: 30px;">{{Auth::user()->name}}'s Profile</h1>
        </div>
        <div class="post-body">
            <div class="col-md-6" style="width: 350px">
                <div class="shadow-md p-3 " id="write">
                    <button class="write-2 form-control" style="color:rgb(253, 252, 252);background-color: #034a5f;" data-toggle="modal" data-target="#click"> Create new talk</button>
                </div>
            </div>
