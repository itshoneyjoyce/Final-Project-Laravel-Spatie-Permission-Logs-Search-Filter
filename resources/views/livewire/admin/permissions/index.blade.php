<div>
    <div class="container mt-3">
        <h1 class="text-left" style="font-weight: 800; color:rgb(14, 105, 117); font-size: 30px;">Permissions</h1>
        @include('livewire.modals.admin-modal')
        @if (session('message'))
            <div class="alert alert-success text-black text-center" id="messagee">{{ session('message') }}</div>
        @endif
        <div class='btn btn-primary btn-sm float-end mb-2'  style="background-color: #0d94ee; color:rgb(0, 0, 0);" data-toggle="modal" data-target="#modal-permissions">  Create New Permission</div>
        ...
        <div class="card-body">
            <table class="table shadow text-center">
                <thead style="background-color:#f8fcfb; color:#000000;">
                    <tr>
                        <th>Name</th>
                        <th>Action</th>
                    </tr>
