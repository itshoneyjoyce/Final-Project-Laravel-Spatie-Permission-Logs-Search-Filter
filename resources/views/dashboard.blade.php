...
@section('content')
    <div class="container">
        <h1 class="text-center" style="font-weight: 800; color:rgb(14, 105, 117); font-size: 30px;">Dashboard</h1>
        <div class="content " style="position: relative; margin-left: 300px;">
            <div class="row mt-5 text-center">
                {{-- <div class="col-md-3 mb-2">
                    <div class="card shadow">
                        <a href="/recent-post" id="dash-link">
                            <div class="card-body rounded " style="background-color:#12a08b;">
                                <div class="row">
                                    <div class="col">
                    ...
                    <div class="card border-left-primary shadow h-100 py-2">
                        <div class="card-body">
                            ...
                            <div class="row no-gutters align-items-center">
                                ...
                                <div class="col-auto">
                                    <img src="https://cdn-icons-png.flaticon.com/512/4210/4210758.png" width="30" height="30" class="rounded">
                                </div>
                            </div>
                            </a>
                        </div>
                    ...
                    <div class="card border-left-success shadow h-100 py-2">
                        <div class="card-body">
                            ...
                            <div class="row no-gutters align-items-center">
                                ...
                                <div class="col-auto">
                                    <img src="https://cdn-icons-png.flaticon.com/512/4013/4013895.png" width="30" height="30" class="rounded">
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="card border-left-warning shadow h-100 py-2">
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                            ...
                                            <div class="col-auto">
                                                <img src="https://cdn-icons-png.flaticon.com/512/7915/7915015.png" width="30" height="30" class="rounded">
                                            </div>
                                    </div>
                                </div>
                            </div>
